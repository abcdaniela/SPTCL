...
parser.add_argument('--fold', type=str,
                    default='fold4', help='cross validation')
...
#这段代码是关于计算图像的总变差（Total Variation，TV）损失的，这是一种常用于图像处理任务中的正则化方法
...
def train(args, snapshot_path):
    ...
    if args.restart:
        dict = torch.load(r'./results_pcl/contrast_acdc_pcl_temp01_thresh035_2023-09-20_10-14-32/model/latest.pth',
