...
from utils_PCL import *
from torch.autograd import Variable
from loss.contrast_loss import SupConLoss
from networks.unet2d import UNet2D_classification
from networks.unet2d import UNet2D_contrastive
...
def main():
    ...
    model = UNet2D_contrastive(in_chns=1, class_num=4)

    if args.restart:
        logger.print('loading from saved model'+args.pretrained_model_path)
        dict = torch.load(r"G:\cardiac_data\WSL4MIS-main\code\results_pcl\contrast_acdc_pcl_temp01_thresh035_2023-09-13_16-59-22\model\latest.pth",
    ...
    scheduler = LR_Scheduler('cos', args.lr, args.epochs, len(train_loader))
